...
if [[ -z "$FORGIT_NO_ALIASES" ]]; then
    alias "${forgit_add:-gAA}"='forgit::add'
    alias "${forgit_reset_head:-grr}"='forgit::reset::head'
    alias "${forgit_log:-glo}"='forgit::log'
    alias "${forgit_diff:-gdd}"='forgit::diff'
    alias "${forgit_ignore:-gi}"='forgit::ignore'
    alias "${forgit_restore:-gckk}"='forgit::restore'
    alias "${forgit_clean:-gcff}"='forgit::clean'
